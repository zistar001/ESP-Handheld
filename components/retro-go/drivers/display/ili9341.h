...
static void lcd_init(void)
{
    ...
    /* NOTE: full-memory clear not done here because SPI CS toggles between
       transactions, which confuses ST7789's continuous RAM write mode.
       The gap at screen edges is handled by the caller if needed. */
}
