...
{
    application("Nintendo Entertainment System", "nes", "nes fc fds nsf zip", "ota_0", 16);
    application("Super Nintendo", "snes", "smc sfc zip", "ota_0", 0);
    application("Nintendo Gameboy", "gb", "gb gbc zip", "ota_0", 0);
    application("Nintendo Gameboy Color", "gbc", "gbc gb zip", "ota_0", 0);
    application("Nintendo Gameboy Advance", "gba", "gba zip", "gbsp", 0);
    application("Nintendo Game & Watch", "gw", "gw", "ota_0", 0);
    // application("Sega SG-1000", "sg1", "sms sg sg1", "ota_0", 0);
    application("Sega Master System", "sms", "sms sg zip", "ota_0", 0);
    application("Sega Game Gear", "gg", "gg zip", "ota_0", 0);
    application("Sega Mega Drive", "md", "md gen bin zip", "gwenesis", 0);
    application("Coleco ColecoVision", "col", "col rom zip", "ota_0", 0);
    application("NEC PC Engine", "pce", "pce zip", "ota_0", 0);
    application("Atari Lynx", "lnx", "lnx zip", "ota_0", 64);
