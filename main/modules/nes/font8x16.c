/* Minimal 8x16 monospace font for ROM browser (ASCII 32-127) */
#include <stdint.h>
const uint8_t font8x16_basic[96][16] = {
    ...
    /*127 DEL */ {0x00,0x00,0x00,0x00,0x00,0x10,0x38,0x6C,0xC6,0xC6,0xFE,0x00,0x00,0x00,0x00,0x00},
};
