...
typedef enum { APP_ID_NONE=-1, APP_ID_NES, APP_ID_XIAOZHI, APP_ID_PC_REMOTE, APP_ID_SETTINGS, APP_ID_ABOUT, APP_ID_WIFI_SETUP, APP_ID_COUNTDOWN, APP_ID_MAX } app_id_t;
