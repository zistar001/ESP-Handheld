...
typedef enum { APP_ID_NONE=-1, APP_ID_NES, APP_ID_KEYBOARD, APP_ID_MOUSE, APP_ID_COUNTDOWN, APP_ID_FORTUNE, APP_ID_RECORDER, APP_ID_SETTINGS, APP_ID_ABOUT, APP_ID_WIFI_SETUP, APP_ID_IP_INPUT, APP_ID_CALIB, APP_ID_MAX } app_id_t;
